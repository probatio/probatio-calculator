                    ...
                    >
                        <div class="component-infos">
							...
							<ul class="component-materials">
								<li class="material" v-for="(material, index) in component.materials" :key="index">
									{{material.amount}}x {{material.name}}
								</li>
							</ul>
						</div>
                        <div class="component-qty">
                            <v-btn icon color="pink" @click="updateCount(countActions.REMOVE)">
        ...
        updateCount(action) {
            ...
            switch (action) {
                case this.countActions.ADD:
                    this.updateComponentQtySelected({ componentId: id, qty: qtySelected + 1 });
                    break;
